...
- **`Codex.IO.Transport`**: Codex-branded transport surface backed by `ExternalRuntimeTransport.Transport`; preserves the historical Codex event contract for app-server and MCP while leaving subprocess ownership in the shared substrate
