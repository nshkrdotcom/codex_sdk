...
- use `gpt-5.6-sol` for quality-first parent and child work
- use `gpt-5.6-terra` for balanced day-to-day parent/child work
- use `gpt-5.6-luna` for fast, high-volume child tasks
- begin with the model's reported default effort, then test one level lower or
  higher for the actual workload
...
3. Start one parent thread on `gpt-5.6-terra`.
