...
- Its terminal summary prints optional start/completion/duration,
  time-to-first-token, and failure payload fields. Missing fields are labeled
  as unavailable for the connected CLI/lane instead of crashing.
